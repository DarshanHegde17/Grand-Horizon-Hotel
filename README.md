...
Browse Rooms - View all available rooms with filters
Room Details - See detailed information and amenities
Book Room - 3-step booking process with date selection and payment
My Bookings - View booking history and cancel if needed
